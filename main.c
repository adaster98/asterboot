/* * ASTERBOOT - Native UEFI Bootloader (Freestanding Clang Version)
 * V11: UI Polish (Centered, Scaled, Magenta Theme)
 */
...
// --- BEST FIT RESOLUTION ---
// Instead of MAX res, we find the mode with ~100-120 cols.
// This ensures text is crisp but large enough to read on 4K.
